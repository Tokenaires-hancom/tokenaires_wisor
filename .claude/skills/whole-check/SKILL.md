...
| 원칙 | diff에서 (clean-check) | 전체에서 (여기) |
|---|---|---|
| 2 파급 범위 | 이번에 한 가지만 고쳤나 | **지금 한 가지만 고칠 수 있는 구조인가** |
| 5 의도 기록 | 이 커밋에 왜가 있나 | **코드에 있는데 왜가 어디에도 없는 영역은 어디인가** |
...
| | 항목 | ❌ | ⚠️ | ✅ |
|---|---|---|---|---|
| **1부** 절대 하지 말 것 (사실) | 7 | 0 | 1 | 6 |
| **2부** 클린 코드 5원칙 (판정) | 5 | 1 | 2 | 2 |
